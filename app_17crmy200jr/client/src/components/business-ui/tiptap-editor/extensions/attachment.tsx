...
import { FileAeColorfulIcon } from '@client/src/components/ui/icons/file-ae-colorful-icon';
import { FileAiColorfulIcon } from '@client/src/components/ui/icons/file-ai-colorful-icon';
import { FileAudioColorfulIcon } from '@client/src/components/ui/icons/file-audio-colorful-icon';
import { FileCodeColorfulIcon } from '@client/src/components/ui/icons/file-code-colorful-icon';
import { FileCsvColorfulIcon } from '@client/src/components/ui/icons/file-csv-colorful-icon';
import { FileKeynoteColorfulIcon } from '@client/src/components/ui/icons/file-keynote-colorful-icon';
import { FilePagesColorfulIcon } from '@client/src/components/ui/icons/file-pages-colorful-icon';
import { FilePsColorfulIcon } from '@client/src/components/ui/icons/file-ps-colorful-icon';
import { FileSketchColorfulIcon } from '@client/src/components/ui/icons/file-sketch-colorful-icon';
import { FileWikiExcelColorfulIcon } from '@client/src/components/ui/icons/file-wiki-excel-colorful-icon';
import { FileWikiImageColorfulIcon } from '@client/src/components/ui/icons/file-wiki-image-colorful-icon';
import { FileWikiPdfColorfulIcon } from '@client/src/components/ui/icons/file-wiki-pdf-colorful-icon';
import { FileWikiPptColorfulIcon } from '@client/src/components/ui/icons/file-wiki-ppt-colorful-icon';
import { FileWikiTextColorfulIcon } from '@client/src/components/ui/icons/file-wiki-text-colorful-icon';
import { FileWikiUnknownColorfulIcon } from '@client/src/components/ui/icons/file-wiki-unknown-colorful-icon';
import { FileWikiVideoColorfulIcon } from '@client/src/components/ui/icons/file-wiki-video-colorful-icon';
import { FileWikiWordColorfulIcon } from '@client/src/components/ui/icons/file-wiki-word-colorful-icon';
import { FileWikiZipColorfulIcon } from '@client/src/components/ui/icons/file-wiki-zip-colorful-icon';
